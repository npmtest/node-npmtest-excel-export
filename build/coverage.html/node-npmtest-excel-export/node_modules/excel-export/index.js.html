...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-excel-export/node_modules/excel-export/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-excel-export">npmtest-excel-export (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-excel-export/node_modules/excel-export/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-excel-export/node_modules/excel-export/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">require('node-zip');
var fs = require('fs'),
Sheet = require('./sheet'),
SortedMap = require('collections/sorted-map');
&nbsp;
Date.prototype.getJulian = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >	return Math.floor((this / 86400000) - (this.getTimezoneOffset() / 1440) + 2440587.5);</span>
};
&nbsp;
Date.prototype.oaDate = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >	return (this - new Date(Date.UTC(1899, 11, 30))) / (24 * 60 * 60 * 1000);</span>
};
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function generateMultiSheets(configs, xlsx) {</span>
...
<span class="cstat-no" title="statement not covered" >		config.name = config.name ? config.name : ('sheet'+i);</span>
<span class="cstat-no" title="statement not covered" >		i++;</span>
<span class="cstat-no" title="statement not covered" >    var sheet = new Sheet(config, xlsx, shareStrings, convertedShareStrings);</span>
<span class="cstat-no" title="statement not covered" >		sheet.generate();</span>
<span class="cstat-no" title="statement not covered" >    convertedShareStrings = sheet.convertedShareStrings</span>
	});
}
&nbsp;
<span class="fstat-no" title="function not covered" >function generateContentType(configs, xlsx) {</span>
<span class="cstat-no" title="statement not covered" >	var workbook = contentTypeFront;</span>
<span class="cstat-no" title="statement not covered" >	configs.forEach( <span class="fstat-no" title="function not covered" >function(config) {</span></span>
<span class="cstat-no" title="statement not covered" >		workbook += '&lt;Override PartName="/'+ config.fileName + '" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml" /&gt;';</span>
	});
<span class="cstat-no" title="statement not covered" >	workbook += contentTypeBack;</span>
<span class="cstat-no" title="statement not covered" >	xlsx.file('[Content_Types].xml', workbook);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function generateRel(configs,xlsx) {</span>
<span class="cstat-no" title="statement not covered" >	var workbook = relFront;</span>
<span class="cstat-no" title="statement not covered" >	var i = 1;</span>
<span class="cstat-no" title="statement not covered" >	configs.forEach( <span class="fstat-no" title="function not covered" >function(config) {</span></span>
<span class="cstat-no" title="statement not covered" >		workbook += '&lt;Relationship Id="rId' + i + '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="worksheets/' + config.name + '.xml"/&gt;';</span>
<span class="cstat-no" title="statement not covered" >		i++;</span>
	});
<span class="cstat-no" title="statement not covered" >	workbook += relBack;</span>
<span class="cstat-no" title="statement not covered" >	xlsx.file('xl/_rels/workbook.xml.rels', workbook);</span>
<span class="cstat-no" title="statement not covered" >	xlsx.file('_rels/.rels', '&lt;?xml version="1.0" encoding="UTF-8" standalone="yes"?&gt;'</span>
			  + '&lt;Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"&gt;' 
			  + '&lt;Relationship Id="rId2" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/extended-properties" Target="docProps/app.xml"/&gt;' 
			  + '&lt;Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workbook.xml"/&gt;&lt;/Relationships&gt;');
}
&nbsp;
<span class="fstat-no" title="function not covered" >function generateWorkbook(configs,xlsx) {</span>
<span class="cstat-no" title="statement not covered" >	var workbook = sheetsFront;</span>
<span class="cstat-no" title="statement not covered" >	var i = 1;	</span>
<span class="cstat-no" title="statement not covered" >	configs.forEach( <span class="fstat-no" title="function not covered" >function(config) {</span></span>
<span class="cstat-no" title="statement not covered" >		workbook += '&lt;sheet name="'+ config.name + '" sheetId="' + i +'" r:id="rId' + i + '"/&gt;';</span>
<span class="cstat-no" title="statement not covered" >		i++;</span>
	});
<span class="cstat-no" title="statement not covered" >	workbook += sheetsBack;</span>
<span class="cstat-no" title="statement not covered" >	xlsx.file('xl/workbook.xml', workbook);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function generateSharedStringsFile(xlsx){</span>
<span class="cstat-no" title="statement not covered" >	if (shareStrings.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >		var sharedStringsFrontTmp = sharedStringsFront.replace(/\$count/g, shareStrings.length);</span>
<span class="cstat-no" title="statement not covered" >		xlsx.file("xl/sharedStrings.xml", (sharedStringsFrontTmp + convertedShareStrings + sharedStringsBack));</span>
	}
<span class="cstat-no" title="statement not covered" >	convertedShareStrings = "";</span>
}
&nbsp;
exports.executeAsync = <span class="fstat-no" title="function not covered" >function(config, callBack) {</span>
...
<span class="cstat-no" title="statement not covered" >		var r = exports.execute(config);</span>
...
<span class="cstat-no" title="statement not covered" >	var xlsx = new JSZip(templateXLSX, {</span>
		base64: true,
		checkCRC32: false
	});
<span class="cstat-no" title="statement not covered" >	shareStrings = new SortedMap();</span>
<span class="cstat-no" title="statement not covered" >	convertedShareStrings = "";  </span>
  
<span class="cstat-no" title="statement not covered" >	var configs = [];</span>
<span class="cstat-no" title="statement not covered" >	if (config instanceof Array) {</span>
<span class="cstat-no" title="statement not covered" >		configs = config;</span>
	}else{
<span class="cstat-no" title="statement not covered" >		configs.push(config);</span>
	}
<span class="cstat-no" title="statement not covered" >	generateMultiSheets(configs, xlsx);</span>
<span class="cstat-no" title="statement not covered" >	generateWorkbook(configs, xlsx);</span>
<span class="cstat-no" title="statement not covered" >	generateRel(configs,xlsx) ;</span>
<span class="cstat-no" title="statement not covered" >	generateContentType(configs, xlsx); </span>
<span class="cstat-no" title="statement not covered" >	generateSharedStringsFile(xlsx);</span>
<span class="cstat-no" title="statement not covered" >	var results = xlsx.generate({</span>
		base64: false,
		compression: "DEFLATE"
	});
<span class="cstat-no" title="statement not covered" >	delete shareStrings;</span>
<span class="cstat-no" title="statement not covered" >	delete xlsx;</span>
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Mon Apr 17 2017 18:52:51 GMT+0000 (UTC)</div>
</div>
</body>
</html>
